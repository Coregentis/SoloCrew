...
export const STARTER_CELL_IDS = V2_STARTER_CELL_IDS;
export const STARTER_CELL_DEFINITIONS = V2_STARTER_CELL_DEFINITIONS;
export const createStarterCellOperationalUnitProjections =
  createV2StarterCellOperationalUnitProjections;
export const createStarterCellsRuntimeStateProjection =
